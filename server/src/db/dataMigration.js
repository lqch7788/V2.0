 ...
 */
export function migrateSeedSourceCreateBy(){
  const db = getDatabase();
 ...
 */
export function migrateSeedSourceSupplier(){
  const db = getDatabase();
  const tableName = 'seed_sources';
 ...
 */
export function migrateSeedlingCreateBy(){
  const db = getDatabase();
 ...
 */
export function migratePlantingCreateBy(){
  const db = getDatabase();
 ...
 */
export function migrateHarvestCreateBy(){
  const db = getDatabase();
 ...
 * 清洗采收记录表的仓库名称（字符串→ID）
 */
export function migrateHarvestWarehouse(){
  const db = getDatabase();
  const tableName = 'harvest_records';
 ...
 */
export function migrateSupplierCreateBy(){
  const db = getDatabase();
 ...
 */
export function migrateFarmTaskCreateBy(){
  const db = getDatabase();
 ...
 * 清洗巡查记录表的温室名称（字符串→ID）
 */
export function migrateInspectionGreenhouse(){
  const db = getDatabase();
 ...
 * 清洗问题记录表的温室名称（字符串→ID）
 */
export function migrateProblemGreenhouse(){
  const db = getDatabase();
 ...
 * 清洗人工记录表的工人名称（字符串→ID）
 */
export function migrateLaborWorker(){
  const db = getDatabase();
  ...
  for (const row of records[0].values) {
    const id = row[idIndex];
    const workerName = row[workerNameIndex];
 ...
 */
export function migrateCropInstanceCreateBy(){
  const db = getDatabase();
 ...
 */
export function migrateInventoryCreateBy(){
  const db = getDatabase();
