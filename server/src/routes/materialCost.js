...
router.post('/', (req, res) => {
    try {
        const { id, cost_code, cost_type, cost_name, category, batch_id, batch_code, greenhouse_id, greenhouse_name, crop_name, material_name, material_type, unit, quantity, unit_price, total_amount, cost_date, supplier_id, supplier_name, remarks, create_by } = req.body;
...
router.post('/energy', (req, res) => {
    try {
        const { id, cost_code, cost_type, greenhouse_id, greenhouse_name, batch_id, batch_code, quantity, unit, unit_price, total_amount, cost_date, meter_start, meter_end, remarks, create_by, crop_name, supplier_id, supplier_name } = req.body;
 ...
 */
router.delete('/energy/:id', (req, res) => {
    try {
        const { id } = req.params;
        const db = getDatabase();
