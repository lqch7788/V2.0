...
router.post('/', (req, res) => {
    try {
        const { id, supplier_code, supplier_name, contact_person, contact_phone, mobile_phone, work_phone, fax, address, supplier_type, supplier_attribute, status, country, province, city, bank_name, bank_card_number, organization, create_date, remarks, create_by } = req.body;
