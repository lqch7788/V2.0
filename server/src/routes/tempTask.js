...
router.post('/', (req, res) => {
    try {
        const { id, task_code, task_title, task_type, task_content, requester_id, requester_name, assignee_id, assignee_name, greenhouse_id, greenhouse_name, area_name, request_date, request_time, priority, status, completion_date, completion_note, remarks, create_by, 
        // 新增字段
        due_date, urgency, estimated_hours, estimated_days, worker_count, actual_hours, progress, reject_count, reject_reason, acceptance_remarks, title, location, } = req.body;
