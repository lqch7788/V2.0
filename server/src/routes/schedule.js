...
router.put('/:id', (req, res) => {
    try {
        ...
        if (updates.work_zone !== undefined) {
            fields.push('work_zone = ?');
            values.push(updates.work_zone);
        }
 ...
 */
router.get('/swap-requests/list', (req, res) => {
    try {
 ...
 */
router.put('/swap-requests/:id', (req, res) => {
    try {
        const { id } = req.params;
