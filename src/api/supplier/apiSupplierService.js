...
function fromBackendFields(record) {
  return {
    id: record.id,
    code: record.supplierCode || record.code || '',
    name: record.supplierName || record.name || '',
    supplierType: record.supplierType || '',
    supplierAttribute: record.supplierAttribute || '',
    contact: record.contactPerson || record.contact || '',
    mobilePhone: record.mobilePhone || record.contactPhone || record.contact_phone || '',
    ...
    city: record.city || '',
    district: record.district || record.area || '',
    ...
    lastEditBy: record.lastEditBy || record.last_edit_by || '',
    lastEditTime: record.lastEditTime || record.last_edit_time || '',
  };
}
...
function toBackendFields(item) {
  return {
    ...
    supplierAttribute: item.supplierAttribute,
