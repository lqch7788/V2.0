...
import {  Indicator, ModalType, ActiveTab, IndicatorCategory  } from '@/types/indicators'
...
<style scoped>
/* 标签页样式覆盖 */
:deep(.indicator-tabs .el-tabs__header) {
  margin: 0;
}

:deep(.indicator-tabs .el-tabs__nav-wrap) {
  padding: 0 8px;
}

:deep(.indicator-tabs .el-tabs__item) {
  padding: 0 20px;
  height: 40px;
  line-height: 40px;
  font-size: 14px;
...
:deep(.indicator-tabs .el-tabs__item.is-active) {
  color: #3b82f6;
}

:deep(.indicator-tabs .el-tabs__active-bar) {
  height: 3px;
  border-radius: 2px;
}

:deep(.indicator-tabs .el-tabs__content) {
  padding: 0 4px 4px;
}
</style>
