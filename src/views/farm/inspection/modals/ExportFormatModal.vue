<!--
  巡检导出格式弹窗
  对标 V1.1 src/components/farm/inspection/modals/ExportFormatModal.tsx
-->
<template>
  <el-dialog v-model="visible" title="导出巡检数据" width="480px" v-dialog-draggable @close="$emit('update:modelValue', false)">
