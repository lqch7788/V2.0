<!--
  出库导出弹窗
  对标 V1.1 src/components/farm/inventory/OutboundExportModal.tsx
-->
<template>
  <el-dialog v-model="visible" title="出库导出" width="560px" v-dialog-draggable @close="$emit('update:modelValue', false)">
