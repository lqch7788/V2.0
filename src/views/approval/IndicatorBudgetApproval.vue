  ...
  <div class="space-y-6">
    ...
    <div class="bg-white rounded-xl p-6 shadow-sm">
      <div class="flex items-center gap-3">
        <div class="w-12 h-12 rounded-lg bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center">
          <el-icon :size="24" class="text-white"><DataLine /></el-icon>
        </div>
        <div>
          <h1 class="text-2xl font-bold text-gray-900">指标预算审批</h1>
          <p class="text-gray-500">指标预算审批流程</p>
        </div>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
      ...
      >
        ...
        <el-table-column prop="amount" label="金额/数量" min-width="120" align="center">
          <template #default="{ row }">
            <span class="text-emerald-600 font-medium">{{ row.amount }}</span>
          </template>
        </el-table-column>
...
// 标签页配置
const tabs = [
  { value: 'indicator', label: '指标发布' },
  { value: 'indicator_adjust', label: '指标调整' },
  { value: 'budget_create', label: '预算编制' },
  { value: 'budget_adjust', label: '预算调整' }
]
...
const typeColorMap = {
  'indicator': 'primary',
  'indicator_adjust': 'warning',
  'budget_create': 'success',
  'budget_adjust': 'danger'
}
...
// 指标预算审批数据
const records = ref([
  { id: '1', code: 'IB2024030101', type: 'indicator', applicant: '张伟民', department: '财务部', amount: '-', createTime: '2024-03-01 09:30', reason: '季度产量指标发布', status: 'pending' },
  { id: '2', code: 'IB2024030102', type: 'indicator_adjust', applicant: '李明轩', department: '财务部', amount: '-', createTime: '2024-03-01 10:15', reason: '番茄产量指标调整', status: 'pending' },
  { id: '3', code: 'IB2024030103', type: 'budget_create', applicant: '王建国', department: '财务部', amount: '¥500,000', createTime: '2024-03-01 11:00', reason: '2024年度预算编制', status: 'pending' },
  { id: '4', code: 'IB2024030104', type: 'budget_adjust', applicant: '赵俊杰', department: '财务部', amount: '¥80,000', createTime: '2024-03-01 14:00', reason: '生产预算调整', status: 'pending' },
  { id: '5', code: 'IB2024022801', type: 'indicator', applicant: '钱文涛', department: '财务部', amount: '-', createTime: '2024-02-28 09:30', reason: '月度产量指标发布', status: 'approved' },
  { id: '6', code: 'IB2024022802', type: 'indicator_adjust', applicant: '孙丽华', department: '财务部', amount: '-', createTime: '2024-02-28 10:15', reason: '黄瓜产量指标调整', status: 'approved' },
  { id: '7', code: 'IB2024022803', type: 'budget_create', applicant: '周建设', department: '财务部', amount: '¥350,000', createTime: '2024-02-28 11:00', reason: 'Q1预算编制', status: 'rejected' },
  { id: '8', code: 'IB2024022701', type: 'budget_adjust', applicant: '吴光明', department: '财务部', amount: '¥50,000', createTime: '2024-02-27 09:00', reason: '设备预算调整', status: 'approved' },
])
