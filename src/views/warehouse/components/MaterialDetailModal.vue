<template>
  ...
  >
      ...
      <div v-if="material">
        ...
        <div class="bg-emerald-50 rounded-lg p-4 mb-4 border border-emerald-200">
          <div class="flex items-center justify-between">
            ...
            <PackageOpen :size="48" class="text-emerald-600" />
          </div>
        </div>
        ...
        <div v-if="material.quantity < material.minStock" class="bg-red-50 border border-red-200 rounded-lg p-4 mt-4">
          <div class="flex items-center gap-2">
            <span class="text-red-600 text-sm font-medium">库存预警</span>
          </div>
    ...
    <template #footer>
      <button class="h-8 px-4 rounded-md text-xs font-medium inline-flex items-center gap-1 bg-gray-100 text-gray-900 hover:bg-gray-200" @click="$emit('close')">关闭</button>
    </template>
  </ElModal>
</template>
