<!--
  请假导出格式弹窗
  对标 V1.1 src/components/labor/leave/modals/LeaveExportFormatModal.tsx
-->
<template>
  <el-dialog v-model="visible" title="导出请假记录" width="480px" v-dialog-draggable @close="$emit('update:modelValue', false)">
