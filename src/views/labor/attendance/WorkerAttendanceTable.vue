<!--
  工人考勤表格组件
  对标 V1.1 src/components/labor/attendance/WorkerAttendanceTable.tsx
-->
<template>
  <el-table :data="data" v-loading="loading" border stripe>
    <el-table-column prop="workerCode" label="工号" width="120">
      <template #default="{ row }"><span class="font-mono">{{ row.workerCode }}</span></template>
    </el-table-column>
    ...
    <el-table-column prop="workHours" label="工时(h)" width="90" align="right" />
