<!--
  加班导出格式弹窗
  对标 V1.1 src/components/labor/overtime/modals/OvertimeExportFormatModal.tsx
-->
<template>
  <el-dialog v-model="visible" title="导出加班记录" width="480px" v-dialog-draggable @close="$emit('update:modelValue', false)">
