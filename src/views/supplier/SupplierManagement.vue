      ...
      <div class="p-4 bg-emerald-50 border-b border-gray-200 -mx-4 -mt-4">
        <div class="grid grid-cols-4 gap-3">
          <div>
            ...
            <input v-model="form.code" :disabled="isEdit" placeholder="手动输入或使用编码生成器" class="w-full h-9 px-3 border border-gray-500 rounded text-sm bg-white disabled:bg-gray-100 disabled:cursor-not-allowed" />
          </div>
          <div>
            <label class="block text-xs font-medium text-emerald-700 mb-1">供应商名称 *</label>
            <input v-model="form.name" class="w-full h-9 px-3 border border-gray-500 rounded text-sm bg-white" />
          </div>
          <div>
            <label class="block text-xs font-medium text-emerald-700 mb-1">供应类型 *</label>
            <select v-model="form.supplierType" class="w-full h-9 px-3 border border-gray-500 rounded text-sm bg-white">
          ...
          <div>
            ...
            <select v-model="form.supplierAttribute" class="w-full h-9 px-3 border border-gray-500 rounded text-sm bg-white">
          ...
          <div>
            ...
            <select v-model="form.organization" class="w-full h-9 px-3 border border-gray-500 rounded text-sm bg-white">
          ...
          <div>
            ...
            <input v-model="form.contact" class="w-full h-9 px-3 border border-gray-500 rounded text-sm bg-white" />
          </div>
          <div>
            <label class="block text-xs font-medium text-emerald-700 mb-1">移动电话 *</label>
            <input v-model="form.mobilePhone" class="w-full h-9 px-3 border border-gray-500 rounded text-sm bg-white" />
          </div>
          <div>
            <label class="block text-xs font-medium text-emerald-700 mb-1">状态</label>
            <select v-model="form.status" class="w-full h-9 px-3 border border-gray-500 rounded text-sm bg-white">
              <option value="合作中">合作中</option>
              <option value="暂停">暂停</option>
              <option value="终止">终止</option>
            </select>
      ...
      <div class="flex-1 overflow-y-auto p-4">
        <div class="grid grid-cols-3 gap-3">
          <div>
            ...
            <input v-model="form.workPhone" class="w-full h-9 px-3 border border-gray-500 rounded text-sm" />
          </div>
          <div>
            <label class="block text-xs font-medium text-gray-700 mb-1">传真</label>
            <input v-model="form.fax" class="w-full h-9 px-3 border border-gray-500 rounded text-sm" />
          </div>
          <div>
            <label class="block text-xs font-medium text-gray-700 mb-1">国家</label>
            <input v-model="form.country" class="w-full h-9 px-3 border border-gray-500 rounded text-sm" />
          </div>
          ...
          <div class="col-span-3">
            ...
            <input v-model="form.address" class="w-full h-9 px-3 border border-gray-500 rounded text-sm" />
          </div>
          <div>
            <label class="block text-xs font-medium text-gray-700 mb-1">开户行</label>
            <input v-model="form.bankName" class="w-full h-9 px-3 border border-gray-500 rounded text-sm" />
          </div>
          <div class="col-span-2">
            <label class="block text-xs font-medium text-gray-700 mb-1">银行卡号</label>
            <input v-model="form.bankCardNumber" class="w-full h-9 px-3 border border-gray-500 rounded text-sm font-mono" />
          </div>
          <div>
            <label class="block text-xs font-medium text-gray-700 mb-1">创建时间</label>
            <input type="date" v-model="form.createDate" class="w-full h-9 px-3 border border-gray-500 rounded text-sm" />
          </div>
          <div>
            <label class="block text-xs font-medium text-gray-700 mb-1">最后编辑人</label>
            <input v-model="form.lastEditBy" class="w-full h-9 px-3 border border-gray-500 rounded text-sm" />
          </div>
          <div>
            <label class="block text-xs font-medium text-gray-700 mb-1">最后编辑时间</label>
            <input v-model="form.lastEditTime" class="w-full h-9 px-3 border border-gray-500 rounded text-sm" />
          </div>
          <div class="col-span-3">
            <label class="block text-xs font-medium text-gray-700 mb-1">备注</label>
            <textarea v-model="form.remarks" rows="2" class="w-full px-3 py-2 border border-gray-500 rounded text-sm"></textarea>
          </div>
        </div>
      </div>
