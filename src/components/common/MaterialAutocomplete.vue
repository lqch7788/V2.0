...
<template>
  <div class="relative w-full">
    ...
    <!-- 下拉结果 -->
    <div
      v-if="openDropdown && filteredResults.length > 0"
      class="absolute z-[999] mt-0.5 bg-white border border-gray-200 rounded-md shadow-lg max-h-48 overflow-y-auto w-full"
    >
      <button
...
function handleChange(newVal) {
  ...
  // 同时发出 update:value（Vue3 v-model:value 兼容）和 change 事件
