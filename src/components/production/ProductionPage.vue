...
<template>
  <div v-loading="hook.isLoading" class="space-y-6">
    ...
    <ProductionFilters
      ...
      @batch-code-change="hook.setBatchCodeSearch"
      @planting-mode-change="hook.setPlantingModeSearch"
      @crop-name-change="hook.setCropNameSearch"
      @variety-change="hook.setVarietySearch"
      @greenhouse-change="hook.setGreenhouseSearch"
      @status-change="hook.setStatusFilter"
      @plan-type-change="hook.setPlanTypeFilter"
      @reset="hook.resetFilters"
      @search="() => {}"
    />
    ...
    <BatchEditModal
      ...
      @update:selected-batch-code="hook.setSelectedBatchCode"
      @update:edited-batches="hook.setEditedBatches"
      @update:edited-batch-codes="hook.setEditedBatchCodes"
