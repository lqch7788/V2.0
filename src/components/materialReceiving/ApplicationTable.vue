  ...
  <div class="bg-white rounded-xl shadow-sm overflow-hidden mt-4">
    ...
    <div class="p-4 border-b border-gray-100 flex items-center justify-between">
      ...
      <div v-else-if="batchEditMode === 'edit'" class="flex gap-2">
        <button class="h-8 px-3 rounded-md text-xs font-medium bg-emerald-600 text-white hover:bg-emerald-700 inline-flex items-center gap-1" @click="handleBatchEditConfirm">
          确认编辑
        </button>
      ...
      <div v-else class="flex gap-2">
        <button class="h-8 px-3 rounded-md text-xs font-medium bg-emerald-600 text-white hover:bg-emerald-700 inline-flex items-center gap-1" @click="$emit('add-modal-open')">
          <Plus class="w-4 h-4" />
          新增
        </button>
        <button class="h-8 px-3 rounded-md text-xs font-medium bg-blue-600 text-white hover:bg-blue-700 inline-flex items-center gap-1" @click="handleBatchEditClick">
          <Edit class="w-4 h-4" />
          编辑
        </button>
        <button class="h-8 px-3 rounded-md text-xs font-medium bg-red-600 text-white hover:bg-red-700 inline-flex items-center gap-1" @click="$emit('batch-delete')">
          <Delete class="w-4 h-4" />
          删除
        </button>
        <button class="h-8 px-3 rounded-md text-xs font-medium bg-emerald-600 text-white hover:bg-emerald-700 inline-flex items-center gap-1" @click="$emit('export-mode-change', true)">
          <Download class="w-4 h-4" />
          导出
        </button>
      </div>
