/**
 * 2026-07-22 1:1 迁移自 V1.1 recordModalConstants.ts
 * RecordModal 共享常量
 * - 操作类型按繁殖模式分类
 * - 世代选项（27 个，覆盖有性+无性）
 * - 繁殖方式 + 目标性状
...
export const SEXUAL_OPERATION_TYPES = ['cross', 'self', 'backcross', 'selection', 'marker', 'other']

/**
 * @deprecated 2026-07-03 v5：无性繁殖（组培/扦插/嫁接/压条/分株）已迁移至育苗模块
 * 保留此数组用于历史记录展示和导出，前端 UI 不再创建新的无性繁殖记录
 */
export const ASEXUAL_OPERATION_TYPES = ['clonal', 'cutting', 'grafting', 'layering', 'tissue', 'division']
...
// ============ 繁殖方式（无性专用）============
export const PROPAGATION_METHOD_LABELS = {
  cutting: '扦插',
  grafting: '嫁接',
  layering: '压条',
  tissue_culture: '组培',
...
export const TARGET_TRAIT_OPTIONS = ['抗病', '优质', '早熟', '丰产', '抗逆', '雄性不育', '其他']
