  ...
  >
    <el-form :model="form" label-width="100px" ref="formRef">
      <el-form-item label="种源批号">
        <el-input v-model="form.seedCode" disabled />
      </el-form-item>
      ...
      <el-form-item label="可用数量">
        <el-input-number v-model="form.availableCount" :min="0" class="w-full" />
      </el-form-item>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    await seedSourceStore.updateItem(props.record.id, form.value)
