        ...
        <li>
          ...
          <transition name="submenu">
            <ul v-if="approvalExpanded && !collapsed" class="submenu-list">
              <li>
                <router-link to="/approvals" class="submenu-item" :class="{ active: isActive('/approvals') }">
                  <el-icon :size="16"><CircleCheck /></el-icon>
                  <span>审批中心</span>
                </router-link>
              </li>
              ...
              <li>
                <router-link to="/my-applications" class="submenu-item" :class="{ active: isActive('/my-applications') }">
                  <el-icon :size="16"><Document /></el-icon>
                  <span>我的申请</span>
                </router-link>
              </li>
